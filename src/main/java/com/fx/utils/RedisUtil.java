...
public class RedisUtil {
     ...
     * @return 值
     */
    public Object hashGetItem(String key,String item){
    ...
    /**
     * HashSet 如果存在相同key的map相当于map新增参数或者修改
     * @param key 键
     * @param map 对应多个键值
     ...
     */
    public boolean hashSetPush(String key,String item,Object value) {
        try {
     ...
     * @return true 成功 false失败
     */
    public boolean hashSetPush(String key,String item,Object value,long time) {
        try {
            redisTemplate.opsForHash().put(key, item, value);
            if(time>0){
                expire(key, time);
     ...
     */
    public void hashDelItems(String key, Object... item){
     ...
     * @return
     */
    public boolean listSetRightPush(String key, Object value) {
        try {
     ...
     * @return
     */
    public boolean listSetRightPush(String key, Object value, long time) {
        try {
            redisTemplate.opsForList().rightPush(key, value);
            if (time > 0) expire(key, time);
            return true;
     ...
     * @return
     */
    public boolean listSetLeftPush(String key, Object value) {
        try {
     ...
     * @return
     */
    public boolean listSetLeftPush(String key, Object value, long time) {
        try {
            redisTemplate.opsForList().leftPush(key, value);
            if (time>0) expire(key,time);
            return true;
     ...
     * @return
     */
    public Object listSetRightPop(String key) {
        try {
     ...
     * @return
     */
    public Object listSetLeftPop(String key) {
        try {
