...
public class UserOfZhiHu {
    ...
    public void setAllowmessage(String allowmessage) {
        this.allowmessage = allowmessage == null ? null : allowmessage.trim();
    }
    ...
    public void setArticlescount(String articlescount) {
        this.articlescount = articlescount == null ? null : articlescount.trim();
    }
    ...
    public void setAvatarhue(String avatarhue) {
        this.avatarhue = avatarhue == null ? null : avatarhue.trim();
    }
    ...
    public void setColumnscount(String columnscount) {
        this.columnscount = columnscount == null ? null : columnscount.trim();
    }
    ...
    public void setCommercialquestioncount(String commercialquestioncount) {
        this.commercialquestioncount = commercialquestioncount == null ? null : commercialquestioncount.trim();
    }
    ...
    public void setEmployments(String employments) {
        this.employments = employments == null ? null : employments.trim();
    }
    ...
    public void setFavoritecount(String favoritecount) {
        this.favoritecount = favoritecount == null ? null : favoritecount.trim();
    }
    ...
    public void setFavoritedcount(String favoritedcount) {
        this.favoritedcount = favoritedcount == null ? null : favoritedcount.trim();
    }
    ...
    public void setFollowercount(String followercount) {
        this.followercount = followercount == null ? null : followercount.trim();
    }
    ...
    public void setFollowingcolumnscount(String followingcolumnscount) {
        this.followingcolumnscount = followingcolumnscount == null ? null : followingcolumnscount.trim();
    }
    ...
    public void setFollowingcount(String followingcount) {
        this.followingcount = followingcount == null ? null : followingcount.trim();
    }
    ...
    public void setFollowingfavlistscount(String followingfavlistscount) {
        this.followingfavlistscount = followingfavlistscount == null ? null : followingfavlistscount.trim();
    }
    ...
    public void setFollowingquestioncount(String followingquestioncount) {
        this.followingquestioncount = followingquestioncount == null ? null : followingquestioncount.trim();
    }
    ...
    public void setFollowingtopiccount(String followingtopiccount) {
        this.followingtopiccount = followingtopiccount == null ? null : followingtopiccount.trim();
    }
    ...
    public void setHostedlivecount(String hostedlivecount) {
        this.hostedlivecount = hostedlivecount == null ? null : hostedlivecount.trim();
    }
    ...
    public void setIncludedanswerscount(String includedanswerscount) {
        this.includedanswerscount = includedanswerscount == null ? null : includedanswerscount.trim();
    }
    ...
    public void setIncludedarticlescount(String includedarticlescount) {
        this.includedarticlescount = includedarticlescount == null ? null : includedarticlescount.trim();
    }
    ...
    public void setIncludedtext(String includedtext) {
        this.includedtext = includedtext == null ? null : includedtext.trim();
    }
    ...
    public void setIsblocking(String isblocking) {
        this.isblocking = isblocking == null ? null : isblocking.trim();
    }
    ...
    public void setIsforcerenamed(String isforcerenamed) {
        this.isforcerenamed = isforcerenamed == null ? null : isforcerenamed.trim();
    }
    ...
    public void setIsprivacyprotected(String isprivacyprotected) {
        this.isprivacyprotected = isprivacyprotected == null ? null : isprivacyprotected.trim();
    }
    ...
    public void setLogscount(String logscount) {
        this.logscount = logscount == null ? null : logscount.trim();
    }
    ...
    public void setMessagethreadtoken(String messagethreadtoken) {
        this.messagethreadtoken = messagethreadtoken == null ? null : messagethreadtoken.trim();
    }
    ...
    public void setMutualfolloweescount(String mutualfolloweescount) {
        this.mutualfolloweescount = mutualfolloweescount == null ? null : mutualfolloweescount.trim();
    }
    ...
    public void setParticipatedlivecount(String participatedlivecount) {
        this.participatedlivecount = participatedlivecount == null ? null : participatedlivecount.trim();
    }
    ...
    public void setPinscount(String pinscount) {
        this.pinscount = pinscount == null ? null : pinscount.trim();
    }
    ...
    public void setThankfromcount(String thankfromcount) {
        this.thankfromcount = thankfromcount == null ? null : thankfromcount.trim();
    }
    ...
    public void setThanktocount(String thanktocount) {
        this.thanktocount = thanktocount == null ? null : thanktocount.trim();
    }
    ...
    public void setThankedcount(String thankedcount) {
        this.thankedcount = thankedcount == null ? null : thankedcount.trim();
    }
    ...
    public void setVotefromcount(String votefromcount) {
        this.votefromcount = votefromcount == null ? null : votefromcount.trim();
    }
    ...
    public void setVotetocount(String votetocount) {
        this.votetocount = votetocount == null ? null : votetocount.trim();
    }
    ...
    public void setVoteupcount(String voteupcount) {
        this.voteupcount = voteupcount == null ? null : voteupcount.trim();
    }
    ...
    public String toString() {
        return "UserOfZhiHu{" +
                ...
                ", followingcolumnscount='" + followingcolumnscount + '\'' +
                ", followingcount='" + followingcount + '\'' +
                ", followingfavlistscount='" + followingfavlistscount + '\'' +
                ...
                ", id='" + id + '\'' +
                ", includedanswerscount='" + includedanswerscount + '\'' +
                ...
                ", thankfromcount='" + thankfromcount + '\'' +
                ", thanktocount='" + thanktocount + '\'' +
                ", thankedcount='" + thankedcount + '\'' +
                ", type='" + type + '\'' +
                ", url='" + url + '\'' +
                ", urltoken='" + urltoken + '\'' +
                ", usertype='" + usertype + '\'' +
                ", votefromcount='" + votefromcount + '\'' +
                ", votetocount='" + votetocount + '\'' +
